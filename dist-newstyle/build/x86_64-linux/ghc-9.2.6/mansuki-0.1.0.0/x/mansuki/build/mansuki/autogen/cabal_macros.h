...
/* package mansuki-0.1.0.0 */
#ifndef VERSION_mansuki
#define VERSION_mansuki "0.1.0.0"
#endif /* VERSION_mansuki */
#ifndef MIN_VERSION_mansuki
#define MIN_VERSION_mansuki(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mansuki */
...
/* package optparse-simple-0.1.1.4 */
#ifndef VERSION_optparse_simple
#define VERSION_optparse_simple "0.1.1.4"
...
#define CURRENT_COMPONENT_ID "mansuki-0.1.0.0-inplace-mansuki"
